"""
Django settings for BookingPlan project.
...
SECRET_KEY = 'django-insecure-7vd+10ph@x+g5t)_7e%i%rb7-@w8$aapv1cd98*3q7$c^$(ksh'
...
WSGI_APPLICATION = 'BookingPlan.wsgi.application'
